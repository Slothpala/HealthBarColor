...
local frame = CreateFrame("Frame", "HealthBarColorOptions", UIParent, "PortraitFrameTemplate")
...
frame:HookScript("OnShow",function()
    ACD:Open("HealthBarColor_options",container)
end)
frame:HookScript("OnHide",function()
    container:ReleaseChildren()
end)

function HealthBarColor:GetOptionsFrame()
    return frame
end
