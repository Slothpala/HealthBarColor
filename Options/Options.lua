...
local options = {
    ...
    args = {
        ...
        Modules = {
            ...
            type = "group",
            hidden  = function() return not ((HealthBarColor.db.profile.Settings.Modules.Textures or HealthBarColor.db.profile.Settings.Modules.BackgroundTextures or HealthBarColor.db.profile.Settings.Modules.DebuffColor or HealthBarColor.db.profile.Settings.Modules.Glow)) or not isRetail end,
            args = {
                Textures = {
                    order = 1,
                    name = L["Textures"],
                    type = "group",
                    inline = true,
                    hidden  = (function() return not HealthBarColor.db.profile.Settings.Modules.Textures end) or not isRetail,
                    args = {
                        healthbar = {
                            order = 1,
                            type = "select",
