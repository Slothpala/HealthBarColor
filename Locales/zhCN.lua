...
--Overabsorb
L["Overabsorb_name"] = "过量吸收"
L["Overabsorb_desc"] = "在生命条上方单独显示超出最大生命值的吸收量。\n|cffff7f00 注意：受限于游戏内部接口机制，当生命值较低且存在大额过量吸收时，该进度条无法做到完全等比例显示。|r"
--MinimapButton
...
L["PersonalResourceDisplay_desc"] = "启用个人资源显示的材质与色彩设置选项。"
--Profile Management:
